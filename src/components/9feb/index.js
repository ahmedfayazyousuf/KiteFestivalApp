...
const TimeSlot = () => {
    ...
    function Handleclick(e){
        ...
        if(e === 'areaone4:30'){
            ...
            document.getElementById('areaone6:30k').style.color = "black";
            ...
            document.getElementById('areaone6:30s').style.color = "black";
        ...
        <div style={{display: 'flex', justifyContent: 'center', flexDirection: 'column', alignItems: 'center', height: '100vh', width: '100vw', backgroundImage: `url("wallpaper2.jpg")`, backgroundRepeat: 'no-repeat', backgroundAttachment: 'fixed', backgroundSize: 'cover', margin: '0', padding: '0'}} >
            ...
            <div className="slotparent"  style={{display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems:'center', width: '100%'}}>
                ...
                <div style={{display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', flexDirection: 'row', marginTop: '20px'}}>      
                        ...
                        <button className="grab"  style={{cursor: 'grab', width: '250px', padding: '5px', border: 'none', borderRadius: '10px', backgroundColor: '#54B2E9', color: 'white', fontSize: '25px', marginLeft: '20px'}} variant="contained" onClick={HandleSubmit}>SUBMIT</button>
                </div>
