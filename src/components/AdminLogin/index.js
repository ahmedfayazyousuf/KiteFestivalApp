            ...
            <div style={{display:"flex", flexDirection:"column", width:"100vw", height: "100vh", justifyContent:"center", alignItems:"center"}}>
                ...
                <div style={{display: 'flex', flexDirection: 'column', width: '70%', gap:'10px', alignItems: 'center'}}>
                    ...
                    <div style={{display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', flexDirection: 'row', gap:"20px", marginTop: '20px'}}>      
                        ...
                        <button className="grab"  style={{cursor: 'grab', width: '200px', padding: '5px', border: 'none', borderRadius: '10px', backgroundColor: '#54B2E9', color: 'white', fontSize: '25px'}} variant="contained" onClick={Check}>Submit</button>
                    </div>
                </div>
